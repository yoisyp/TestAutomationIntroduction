...
public class Locators2 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		//WebDriver driver = new FirefoxDriver(); driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(5));
	...
	public static String getPasword(WebDriver driver) throws InterruptedException
	{
		driver.get("https://rahulshettyacademy.com/locatorspractice/");
